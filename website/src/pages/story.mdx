...
![Distribution of difference between human computed distances and LLM computed distances](../components/charts/difference_humans_llm.png)
![Distribution of difference between human computed distances and embeddings euclidean distance](../components/charts/difference_humans_euclidean.png)
